...
Let's load the **infer** package.  We're going to use the function `rep_sample_n()` to reample from our data 1,000 times:
...
tibble(`Subject` = "Joe",
       `$Y_{bty\\_avg = 7}$` = c("$4$"),
       `$Y_{bty\\_avg = 8}$` = c("$(4.034, 4.099)$"),
       `$\\widehat{bty\\_avg}$` = c("$(0.034, 0.099)$")) %>%
