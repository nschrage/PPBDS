...
We can use our slope coefficient from the linear regression to fill in the missing potential outcome:
...
tibble(`Subject` = "Joe",
       `$bty\\_avg = 7$` = c("$4$"),
       `$bty\\_avg = 8$` = c("$(4.034, 4.099)$"),
       `$\\Delta bty\\_avg$` = c("$(0.034, 0.099)$")) %>%
...
## Appendix: Best-fitting line {#leastsquares}
