...
house_interact_model %>%
  ...
  geom_point() +
  geom_errorbar() +
  labs(y = "Predicted probability of a Democratic victory",
       x = "") +
  theme_classic()
```
