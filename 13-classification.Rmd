...
tree_fit_best <- update(tree_fit, cost_complexity = best_cost)
...
cart_preds <- 1 * (predict(state_year_tree$fit)[, 2] > 0.5)
...
house_cart_2016 <- caret::train(factor(dem_win) ~ region_fct + state_fct + year,
                         method = "rpart",
