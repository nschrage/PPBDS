...
How do we interpret the coefficients in this model?  Since the `year` coefficient is positive, that means that each additional year *reduces* the odds of a Democratic victory. 
