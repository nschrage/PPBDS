...
An example Preceptor Table for 3,433 folks (the number of rows in `nes_2016`) would be something like this.
...
tibble(Name = c("Alex", "Betty", "...", "Carl", "Diane"),
       ...
       Income = c("0 - 16", "68-95", "...", "34-67", "7-33"),
       Education = c("Adv. Degree", "Highschool", "...", "Elementary", "Adv. Degree"),
  ...
  tab_spanner(label = "Covariates", columns = vars(Age, State, Gender, Income, Education, Race))
```
