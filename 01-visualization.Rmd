...
You can see that while some things are not *necessary* to create a plot, they can make a big difference in how much information we can derive from it.  
...
Plotting is cool. Go practice!

<!-- Mention rayshader package and show some examples of three d plots. Super cool! -->

<!-- https://www.rayshader.com/#3d-plotting-with-rayshader-and-ggplot2 -->

<!-- Mention plotly package and so how to make similar plots with it -->
