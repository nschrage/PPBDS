...
<!-- Outline: Need to be 5 to 8 sections. And within each ## subpart, you have 5 to 8 ### sub-subparts. -->

<!-- 1) Preamble. Let's do some R. Read the Shopping Week chapter to get set up. From the R Console, load tidyverse. Also install two data packages. install.packages("tidyverse"). Install data packages. -->

<!-- 2) Have Some Cake! -->

<!-- 3) East Your Vegetables! -->

<!-- 4) Basic Plot Types -->

<!-- 5) Introduce Tidyverse -->
...
<!-- EWF: Added from Chapter 2. Jessica decide whether this is useful for you --> 
