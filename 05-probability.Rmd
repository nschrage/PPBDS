...
<!-- 1) Make rayshader.R. Creates all images and animations, places them in either images or animations folder. Lots of info and advice for whomever needs to work with this later. Get rid of all images/animations/code which we are not using. -->
...
```{r, echo=FALSE}
# Some comments about this. Where did you get this data from? Why those columns?
...
How would you express this in statistical notation? p(A|B) is the same thing as the probability of A *given* B. p(A|B) essentially means the probability of A *if* we know for sure the value of B. You should also remember that $p_{A|B}$ is not the same thing as $p_{B|A}$.
...
<!-- hello! Welcome to my city of 100,000 people. Some people have a disease. Some people do not. Some people have a positibve result when we give them a test for the disease. Some people have a negative result when we test them. Here is the joint empirical distribution of test result and disease status. -->
...
ggplot(pop, aes(x = as.factor(have_disease), y = as.factor(positive_test))) +
  ...
  geom_jitter(alpha = .4) +
  theme_classic() +
  labs(title = "Joint Unnormalized Empirical Distribution of Test Results and Disease Status",
    x = "Test Result",
    y = "Disease Status")
