...
There are probability distributions (which are mathematical formulas, using fair dice). There are frequency (empirical) distributions (which are data). Compare math of two dice and frequency of rolling 1,000 times. There are posterior (predictive) distributions which are measures of your belief about things you can't see. All are p(). 
