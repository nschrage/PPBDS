...
done VZ (changed to small p, added a section at the start of the probability distribution section on the difference between p(H) and p(Coin)-->
...
<!-- Add ### in first section for Flipping a coin; Rolling two die, and  done, VZ-->
