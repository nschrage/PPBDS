...
The first task with fortitude is unmodeled variation. A residual is the variation that is not contained in the model. This is explains why the result is equal to the fitted (also known as expected) value plus the residual.
