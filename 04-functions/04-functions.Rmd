...
<!-- First talk about list columns. Then talk about how u need a map to act on it. Then get into functions which are being mapped. Then anonymous funuctions. -->
...
<!-- MB: This is where you need to fill in the gap between map functions and functions in general -->
