...
<!-- https://github.com/davidkane9/PPBDS/blob/master/misc/set-up.Rmd -->

<!-- Submit PR with tiny change to confirm working. -->

<!-- Read Gelman chapters. -->

<!-- Review themes.Rmd. -->

<!-- Work on age ~ party section. -->
