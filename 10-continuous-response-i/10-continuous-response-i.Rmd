---
title: "Continuous Response I"
---

# Continuous Response I {#regression}
...
<!-- holdout sample, cross validation, machine learning  -->
...
<!-- DK: Interesting presentation: https://twitter.com/nickchk/status/1274853247694467072 -->
...
<!-- EG: After reading through a couple of other chapters, I definitely don't think this is necessary -->
...
Additional Packages For Advanced Section: 
...
<!-- EG: I think that using US Congress campaigns data sounds like a good plan. And using list cols would work very well with these models! -->
...
<!-- EG: I agree that RCM and potential outcomes would fit well within this discussion. -->
...
knitr::include_graphics("images/shoes_headache.png")
```
...
knitr::include_graphics("images/flowchart.009-cropped.png")
```
...
Let's explore differences in life expectancy in two ways:
...
```{r, echo=TRUE, warning=FALSE, fig.cap="Histogram of life expectancy in 2007."}
gapminder2007 %>%
...
```{r, echo=FALSE, warning=FALSE, fig.cap="Life expectancy in 2007."}
...
```{r, warning=FALSE, fig.cap="Life expectancy in 2007."}
gapminder2007 %>%
...
* `data_frame_name` is the name of the data frame that contains the variables `y` and `x`. In our case, `data_frame_name` is the `evals_ch11` data frame.
* `refresh = 0` is optional. Setting refresh equal to 0 suppresses the priting of the sampling algorithm from the model. We will touch more on this later. 
