...
<!-- Explain PPBDS.data and how to install it at start of chapter. -->

<!-- Figure out the 5-8 subparts and the sub-subparts within each. -->

<!-- Fix summarize warnings. -->
...
<!-- b) We can replicate this experiment 1,000 times. Sample, without replacement, 10 classes from 2018F. Use the bootstrap to calculate a confidence interval for the mean. This should include the mean about 950 of the 1,000. But it will fail about 500 times! And that is cool to show. -->
