...
<!-- TA: I don't know what I am doing wrong, but I can't find a sample size argument in bootstraps() like rep_sample_n() has.
...
<!-- TA: is this estimands or something?
...
<!-- TA: I like pennies example, but if you want a smaller dataset, thats cool too. 
...
<!-- TA: I think we should say we collect a random sample of 50 pennies instead of just a sample of 50 pennies-->
...
<!-- TA: Again, maybe 50 randomly sampled pennies-->
...
<!-- TA: so should i refer to everything as data even though it may override previous code? Im assuming you want me to use the confidence interval tidy approach but with bootstraps?-->
...
<!-- TA: Is it because there were many bootstrap CI but only one is used with lm? -->
