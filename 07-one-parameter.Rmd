...
<!-- Similar to current chapter, but also estimate median, 3rd biggest, IQR. -->
...
if(!file.exists("data/sampling_scenarios.rds")){
  sampling_scenarios <- "https://docs.google.com/spreadsheets/d/e/2PACX-1vRd6bBgNwM3z-AJ7o4gZOiPAdPfbTp_V15HVHRmOH5Fc9w62yaG-fEKtjNUD2wOSa5IJkrDMaEBjRnA/pub?gid=0&single=true&output=csv" %>% 
    read_csv(na = "") %>% 
    slice(1:5)
  write_rds(sampling_scenarios, "data/sampling_scenarios.rds")
} else {
  sampling_scenarios <- read_rds("data/sampling_scenarios.rds")
}
...
if(!file.exists("data/pennies_resample.rds")){
  pennies_resample <- pennies_sample %>% 
    rep_sample_n(size = 50, replace = TRUE, reps = 1) %>% 
    ungroup() %>% 
    select(-replicate)
  write_rds(pennies_resample, "data/pennies_resample.rds")
} else {
  pennies_resample <- read_rds("data/pennies_resample.rds")
}
