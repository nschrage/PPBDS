...
# don't use in code which students see.
...
<!-- DK: Huh? "Get git pictures" This is cuz xome of the images were deleted --> 
...
<<<<<<< HEAD
# DK: The below is an absurd hack. Create a proper gt table directly. Then, you
# can delete the data directory.
>>>>>>> master
=======
>>>>>>> master
=======
