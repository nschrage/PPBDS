...
`r margin_note("Make sure to run `remotes::install_github('davidkane9/PPBDS.data')` if you have not yet installed the **PPBDS.data** package. **rsample** is available on CRAN via the usual `install.packages('rsample')`.")
