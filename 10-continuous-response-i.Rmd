...
<!-- DK: I am considering some major changes in this chapter. What if this were a chapter of "Tricks and Traps", or some such? That would allow us to cover all the remain problems before doing our final tour of models in chapters 11 and 12. It also would make those chapters more parallel in construction.

What might go in this chapter in that event?

Overfitting/underfitting. It would be nice to nail all the complexities of this down. Should we even bother to explore it in chapter 9?
