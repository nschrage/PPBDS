...
The **tidyverse** package will be used in every chapter. **nycflights** is a package with data associated with flights out of New York City's three major airports. **PPBDS.data** includes, as you might guess, data organized for use by this textbook.
