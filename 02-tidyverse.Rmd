...
<!-- 1) "Data Gathering" (?) Download and Reading In (mention col_types, and how to make the message go away) Details on read_csv options. Also using skimr::skim() and janitor::clean_names(). -->

<!-- 2) Characters. Need to update regexp to mention new string constant in R 4.0 -->
