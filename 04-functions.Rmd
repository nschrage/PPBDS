...
<!-- Maybe the running examples should all be stuff from dice, coins and so on, setting the stage for the probability chapter. -->

<!-- Maybe the functions chapter should introduce map functions independent of list-columns. For example, if you want to simulate dice throws in a tibble, you need (?) map function to ensure that you get a different value for each row. -->

<!-- For a tutorial for this chapter, just use the one from RStudio: https://rstudio.cloud/learn/primers/6 -->
...
knitr::include_graphics("images/mvp.jpg")
```
