...
<!--EC: Should we take the pepper shaker analogy directly or find a similar analogy (a jar of individually wrapped Fruit Gushers -- I love those -- or a hotel safe with a passport inside in which you'd need to "iterate" to the photo identification page)?-->

First, we need to know: What are lists? 
...
nhanes %>%
  group_by(age, gender) %>%
  summarize(all_weights = list(c(weight)))
```
