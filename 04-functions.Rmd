...
<!-- 0. Add all of the Primer to the tutorial. Add lots more list-column and map functions, both at the start and at end.  Add 30 list-column and mapping questions, generally with with each set of questions grouped into a mini two or three question series. -->
