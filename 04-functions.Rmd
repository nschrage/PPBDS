...
runif(1,1,6)
```
Nice! We just made our first uniform distribution. Again, note that the output contains decimel numbers. If we really want to simulate the discrete uniform distribution of dice rolling, there is a better function to do so: `sample()`.
