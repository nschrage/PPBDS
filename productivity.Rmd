...
Let's begin with getting familiar with RStudio. Specifically, this section focuses on getting a better handle of your computer's filesystem (it's super important to keep track of files while doing data analysis!)

Begin by opening up RStudio. You should see something like this:
