...
<!-- Better step-by-step guidance in Git set up, like here: https://emmal73.github.io/github_slides.html -->

<!-- Explain what .gitignore and .Rproj files.  -->
...
<!-- Emphasize the file system more, with the tour given from the Terminal window in R Studio. Not understanding how a process can be run from two different places causes endless problems when students build their own Shiny App later. -->
