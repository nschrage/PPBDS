...
<!-- AR: commenting out vast frequentist section for now -->
<!-- Had to delete some outright because references to certain R objects even in
comments caused build problems (?) -->

<!-- The effectiveness of a confidence interval is judged by whether or not it contains the true value of the population parameter. Going back to our fishing analogy in Section \@ref(ci-build-up), this is like asking, "Did our net capture the fish?". -->
