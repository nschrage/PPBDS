...
```{r sampling-distribution-part-deux, fig.show='hold', fig.cap="Previously seen sampling distribution of sample proportion red for $n = 10000$.", echo=TRUE, fig.height=2}
...
```{r bootstrap-distribution-part-deux, fig.show='hold', fig.cap="Bootstrap distribution of proportion red for $n = 10000$.", purl=FALSE, fig.height=2.5}
...
p_samp <- ggplot(sampling_distribution, aes(x = prop_red)) +
  geom_histogram(binwidth = 0.025, boundary = 0.4, fill = "salmon", 
                 color = "white") +
...
p_boot <- ggplot(bootstrap_distribution, aes(x = prop_red)) +
  geom_histogram(binwidth = 0.025, boundary = 0.4, fill = "blue", 
                 color = "white") + 
  labs(x = "Proportion of 50 balls that were red", 
       title = 
