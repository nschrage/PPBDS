...
<!-- Devito image seems small. Is that because it is png? Do jpeg files automagically get scaled so that they are the correct size? -->

<!-- Modify the tutorial. It is not bad, but, with map2, it is a bit much, I think. See the comments. -->

<!-- Start thinking about what we should do in the class. -->
...
```{r, echo=FALSE, fig.cap="Mr. DeVito is correct: sampling *is* badass. Let's get started!"}
...
<!-- MF: Is it worth showing an example of a row of the infinite Preceptor Table? For example, do a row for one young American that lists approval rating, gender, party affiliation, etc.? Or is describing the table enough? -->
...
<!-- MF: When we actually answer this question, should it address the fact that we know the true proportion of red bead sto be 37.5% as stated earlier in the chapter? If so, would the ultimate solution just build a model showing the # of beads at which we get a proportion red between 32.5 - 42.5 90% of the time? How do we show that? -->
...
<!-- MF: Very random thought but- would it be a good idea to hide a bonus point on a pset (or something similar) in the middle of a particularly wordy section? It would reward students that read the entire chapter. -->
