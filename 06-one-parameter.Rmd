...
<!-- 1) Devito image seems small. Is that because it is png? Do jpeg files automagically get scaled so that they are the correct size? Maybe put it as a side margin. -->

<!-- 2) Do the tutorial. Modify the tutorial. It is not bad, but, with map2, it is a bit much, I think. See the comments. -->
