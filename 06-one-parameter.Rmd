...
<!-- 3) Add red line for root(n) to figure 17. Trick is stat_function: https://ggplot2.tidyverse.org/reference/stat_function.html. DONE.-->
...
shovels_100 %>%
  ...
  geom_point() +
  stat_function(aes(x = 0:1000, fun = sqrt, colour = "red")) +
  labs(x = "Shovel size",
...
knitr::include_graphics("06-one-parameter/images/shake shack.png")
```
...
knitr::include_graphics("06-one-parameter/images/tasty burger.png")
``` 
...
<!-- MF: Very random thought but- would it be a good idea to hide a bonus point on a pset (or something similar) in the middle of a particularily wordy section? It would reward students that read the entire chapter. -->
