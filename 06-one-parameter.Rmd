...
#   pull(probs)
# 
# tibble(posterior_p = probs_from_experiment) %>% 
#   mutate(results = map_int(posterior_p, ~ rbinom(n = 1, 
#                                                 size = 100, 
#                                                 prob = .))) %>% 
#   mutate(bigger_than_33 = ifelse(results > 33, TRUE, FALSE))
