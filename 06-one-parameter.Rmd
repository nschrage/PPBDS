...
<!-- 0) Add sqrt(n) plot to show how standard error decreases. There is  ahandy stat_ for doing this in ggplot2. But I deleted it when told me you had done this already. -->
...
<!-- Create three-D plot, like Vivian does in chapter 5 with rayshader. Recommend having separate code which creates the plot, then save the png in images/ and then just read it in. -->

<!-- Add forecast/betting example, like in chapter 5. Maybe, what are the odds that a paddle of size 25 will pull out at least 20 reds? -->
...
#   geom_point() +
#   stat_function(aes(x = 1:100, colour = "red"), fun = sqrt) +
#   labs(x = "Shovel size",
...
```{r, echo=FALSE, fig.cap="Let Yoda's wisdom dull the pain of this terminology section.", fig.margin = TRUE}
...
```{r, echo=FALSE, fig.cap="When you see another Precetor Table section.", fig.margin = TRUE}
