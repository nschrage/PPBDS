...
<!-- Fix the tutorial. Remove map stuff. Tutorial should be consistent with how chapter currently is. No need to add extra stuff. Key is to avoid typos and unclear questions. Number the exercises. Add hints. Maybe keep mapping? Maybe not? Whole thing should take 3 hours. -->


<!-- DK: I will look into this.  Add sqrt(n) plot to show how standard error decreases. There is  handy stat_ for doing this in ggplot2. But I deleted it when told me you had done this already. NOTE: this works for me as is. Maybe because my version of R is old? -->
