...
<!-- Preamble: Life is hard. Things were difficult in Chapter 9. Let us teach you some stuff to make your life easier! And you will get to practice in Chapters 11 and 12. Review themes.Rmd.  -->

<!-- 1. EDA of ch10, which is a curated subset of rows from `nes`. Maybe just 2016. -->

<!-- 2. ideology ~ income gender race. All with rstanarm. Fully explain.  -->
...
The data on the Q Guide scores can be found in the `qscores` data frame included in the **PPBDS.data** package. However, to keep things simple, let's `select()` only the subset of the variables we'll consider in this chapter, and save this data in a new data frame called `qscores_ch10`:
