...
Here, we'll be introducing the `trains` dataset from Enos (2014). In this study, Enos and his team randomly placed Spanish-speaking confederates in nine train stations around Boston, MA. They examined how exposure to Spanish-speakers -- the `treatment` -- influenced attitudes toward immigration. These reactions were measured through changes in exclusionary attitudes regarding immigration. 
...
<!-- EM: Talk about trains like it's a brand new dataset!! I wrote this thinking that it was previously introduced in the book. It should be an introduction and not a refresher (as I wrote it to be) -->
