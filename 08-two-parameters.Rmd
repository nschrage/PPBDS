...
<!-- 5) Simple regression model with intercept and coefficient. Steal from chapter 9. -->

<!-- 6) MAYBE NOT Models requiring the bootstrap. Ratio of average age of democrats versus republicans. -->

<!-- 7) Prediction. Use the models to answer your question. -->
...
We discussed these objects in Chapter \@ref(one-parameter). The key trick in working with them is the use of `analysis()` from the **rsample** package to pull out the underlying data.
