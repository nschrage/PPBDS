...
3) Age by party (modeling for prediction). No use of bootstrap. Make clear the distinction between "modeling for prediction" and "modeling for causation." The first is only about comparisons between categories. The second is stronger, a claim about changing an individual; it is a claim about potential outcomes. Multiple paragraphs throughout the chapter. 
...
<!-- DK: I went fast above, but that is all the key material. -->
...
Let's begin by using `lm()`, in almost the exact same was as we did in Chapter \@ref(one-parameter).
...
<!-- Provide a tour of what this means -->
