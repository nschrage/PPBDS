...
We will break this into two functions, one called `use_shovel()` which will use a shovel of the specified size, and another called `prop_red()` which will calculate the proportion of red for a shovel of the specified red.
...
See that we now could have created the object `virtual_samples_25` with the code `virtual_samples_25 <- use_shovel(25)`.  This is far more succinct than our previous code, and it allows us to use a shovel of any size we'd like.
