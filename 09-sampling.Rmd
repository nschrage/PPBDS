...
use_shovel(x = bowl, size = 25, reps = 1000)
```

See that we now can create the object `virtual_samples_25` with the code `virtual_samples_25 <- use_shovel(x = bowl, size = 25, reps = 1000)`.  This is far more succinct than our previous code, and it allows us to use a shovel of any size we'd like.
...
prop_red(x = bowl, size = 25, reps = 1000)
```
...
```{r, eval = FALSE}
virtual_prop_red_25 <- prop_red(x = bowl, size = 25, reps = 1000)
virtual_prop_red_50 <- prop_red(x = bowl, size = 50, reps = 1000)
virtual_prop_red_100 <- prop_red(x = bowl, size = 100, reps = 1000)
```
