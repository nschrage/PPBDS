...
<!-- Preamble: George Bailey. Show me a movie. Or a gif. End with RCM paragraph. -->

<!-- 1) Preceptor Table. Formal definition. Harvard example with misssing rows. Promise to get more technical later. -->

<!-- 2) Causal effect. Three header columns: outcomes, covariates, estimands  -->

<!-- 3) Simple models. One parameter. Two parameter. -->

<!-- 3) Introduce the themes! Prudence: Infinite Preceptor Table (Is Yao the same? Are the treatments the same? Are new people and new treatments similar enough? Is this treatment effect connected to what my real problem? I don't really care how to change how people fill out anonymous surveys.) Justice: math. Courage: Write some code. Temperance (representativeness). -->
