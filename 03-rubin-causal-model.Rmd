...
<!-- Third, connect all this to the central theme of 98% of social science research --- using observational data to infer causation by treating the assignment mechanism as being close enough to random. Let's discuss. -->

<!-- Experiments in which you know tau is some positive number.

Experiment with known, constant, positive treatment effect and 6 people. (Or whatever small number you like. ) Does random asignment guarantee that we get a good estimate of the treatment effect? No! Easy to get an "unlucky" assignment. But, cool thing, if you try all posssible assignments, the average result will be the treatment effect. This shows why we say that randomized assignment generates an "unbiased" estimate of the treatment effect. The average answer it gives is good. But it is also variable! -->

<!-- Now, same thing with 10,000 (same treatment effect size). Can't calculate all possible assignments. But we can sample. Two things will be true. Average of this sample will be the (true) treatment. And it will be much more precisely estimated. -->

<!-- Overlap the density estimates, the second is much more peaked. -->

<!-- Experiments in which you assume tau = 0. That is what a permutation test is.  -->
...
- One potential outcome for one person, such as Yao's potential outcome under treatment ($13$).  
