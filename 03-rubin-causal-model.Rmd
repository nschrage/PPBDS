...
<!-- use the term "interactions" and "interaction effects". A "specific effect" is not an interaction effect. -->
...
<!-- Discuss block designs, as an example of how their are many ways to do random assignment. Selection bias is when the person doing the assignments chooses on the basis of the potential outcomes. Confounding does not require selection bias. But selection bias is always an example of confounding. -->
