...
<!-- 3) Introduce the themes! Prudence: Infinite Preceptor Table (Is Yao the same? Are the treatments the same? Are new people and new treatments similar enough? Is this treatment effect connected to what my real problem? I don't really care how to change how people fill out anonymous surveys.) CB: Done Justice: math. fortitide: Write some code. Temperance (representativeness). -->

<!-- Preamble: George Bailey caption.  -->

<!-- Design image for side margin for each theme. -->
...
<!-- Should tables have captions? Maybe? -->

<!-- No bolding ID column? ID should be right justified. CB: Done -->

<!-- Educate us about The Cardinal Virtues. (That is, read Wikipedia and give us a summary.) -->
