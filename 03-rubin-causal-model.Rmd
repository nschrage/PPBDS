...
<!-- First, what is the difference between causal models and predictive models? See the updated version of bok/themes.Rmd for discussion. Read the new *estimand* section and apply it in this chapter, with one or two actual Rubin Tables to drive the point home. (Not sure about the best location for this.) CB: Done-->

<!-- Second, explore some subtleties of the (allegedly) clear distinction between predictive and causal models. Is race causal? What about sex? What about a genetic condition like color-blindedness? These are hard questions, and politically fraught! We need to be precise in our writing. This all goes back to "no causation with manipulation." Can we manipulate race? (Example of the Black/White sounding names on resumes.) Can we manipulate sex? What about gender? With gene therapy, we will eventually be able to manipulate things like color-blindness. CB: Done -->
