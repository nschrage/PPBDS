...
<!-- Fix the tutorial. Delete the True Agains. Give enough blank lines for what you expect. CB: Could not figure out how to add more blank lines. Changed format so that it was run doc not knit like the other chapters that was what all the deleting rmd and everything was. -->

<!-- Aggresively cut stuff! This is your chapter. Own every word! CB: Through prudence with cutting stuff but will likely have to go back through again. -->

<!-- Put outcomes on the left, next to ID. CB: Done, check covariates placement. -->

<!-- Add some memes! And videos. And cartoons! TikToks! CB: Avengers randomization still need to find good meme. -->

<!-- Rubin quotes in side margin. -->

<!-- No bolding ID column? ID should be left justified. CB: Done-->

<!-- I reserve the right to come back and whine about table formatting. CB: -- ID subheading?  -->
...
You'll notice we now have a new type of column in our Preceptor Table; covariates! Are we better able to forecast a random students height if we are given their age and sex? 
...
The average treatment effect is the average difference in *potential* outcomes between the treated group and the control group. 
