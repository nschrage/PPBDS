...
Now what if we want the fitted values not just for these two instructors, but for the instructors of all 463 courses included in the `evals_ch12` data frame? Doing this by hand would be long and tedious! This is where the `augment()` function from the **broom** package can help: it will quickly automate the above calculations for all 463 courses. We present a preview of just the first 10 rows out of 463 in Table \@ref(tab:model4-points-table).
