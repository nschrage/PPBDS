...
<!-- options(pkg="binary") needs to be set permanently. When/where do we do that? Or do we need to? -->
...
<!-- Add discussion of Jobs tab and how it is processing the tutorial when we press Start. Show a video of this. -->
...
If you can't get R and R Studio working on your computer, you may use [RStudio Cloud](https://rstudio.cloud) as a backup plan. Go there and set up a free account. Click "New Project". From this point, the instructions are the same regardless of if you are on your own computer or on RStudio Cloud.
...
If you are working on your own computer, copy and the following in to the R Console:
...
The first causes R to download binary (i.e., pre-built) packages by default. Without this option set, you will occasionally be asked by R:
...
This might not be necessary, depending on your R/RStudio set up, but it is certainly needed on RStudio Cloud. Next:
