...
```{marginfigure}
FAS OnDemand provides a very similar experience to [RStudio Cloud](https://rstudio.cloud), a paid plan. Most data science today is done on your own machine, Most data science in the future will be done in the cloud.  
```

Now, let's begin with getting familiar with RStudio, whether on your own machine or on FAS OnDemand. Begin by opening up RStudio. After you open RStudio, you should see three *panes*, or panels, dividing the screen: the *console pane*, the *files pane*, and the *environment pane*. Over the course of this chapter, you'll come to learn what purpose each of these panes serves. You should see something like this:
...
You do not need to run these functions if you are working on FAS OnDemand since we have configured it to be set up correctly.
...
If you are working on FAS OnDemand, none of these steps were necessary. We did everything for you already. 
