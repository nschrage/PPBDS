...
<!-- options(pkg="binary") needs to be set permanently. When/where do we do that? -->
...
Copy and paste the following three commands to the R Console:
...
The other two commands set sensible defaults for working with RStudio.
...
R packages generally live in one of two places: CRAN (rhymes with "clan") for more mature, popular packages and Github for more experimental, less stable packages. 
