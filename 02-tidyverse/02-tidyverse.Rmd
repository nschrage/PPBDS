...
<!-- EF: I think here might be a good moment to take a slightly longer detour and discuss a few other 
...
knitr::include_graphics("images/dplyr_cheatsheet-1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("images/murders-data-wiki-page.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("images/html-code.png")
```
...
knitr::include_graphics("images/data-import-1.png")
```

```{r, echo=FALSE, fig.cap="Data Import cheatsheet (second page): tidyr package."}
knitr::include_graphics("images/data-import-2.png")
```
