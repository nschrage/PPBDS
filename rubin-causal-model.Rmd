...
rather than here. Perhaps this footnote is too much detail. We are not writing Wikipedia entries anymore. -->
...
<!-- Should we stick with this notation? Should the numbers be written in math font? Should we use **gt** tables? -->
