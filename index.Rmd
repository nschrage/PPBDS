...
<!-- This is not a bad cover. But we really should do more. First, we need a good close up of each of the 4 cardinal virtues. It is hard to see them in this shot.  Then, we might add some text about each of the virtues, beginning with the Latin term. Of course, we don't have the space to go into how these terms connect to concepts in data science. Also, it might be nice to tie the book title more closely into this display. Also, maybe we should be using the full width here.  -->
