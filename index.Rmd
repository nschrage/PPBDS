...
The [Cardinal Virtues](https://en.wikipedia.org/wiki/Cardinal_virtues) apply as much to Bayesian data science as they do to life. Come learn them with us.

[Prudence](https://en.wikipedia.org/wiki/Prudence) 

```{r, echo=FALSE}
knitr::include_graphics("other/images/prudence.jpg") 
```

[Justice](https://en.wikipedia.org/wiki/Justice_(virtue))

```{r, echo=FALSE}
knitr::include_graphics("other/images/justice.jpg") 
```

[Fortitude](https://en.wikipedia.org/wiki/Courage)

```{r, echo=FALSE}
knitr::include_graphics("other/images/courage.jpg") 
```
[Temperance](https://en.wikipedia.org/wiki/Temperance_(virtue))
