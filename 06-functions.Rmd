...
## The list columns and  map_* functions
...
<!-- 5) Throughout we are leaving lots of stuff out. No broom, for example. We are purposely keeping to the simplesy possible use, which involves simulation games of various kinds. I don't think we need nest() or unnest() at this stage. -->
