...
```{r glimpse_geography, echo = FALSE}
glimpse(rural)
```
...
- Give the legend an informative title
...
We'll also use `theme_void()`, a great theme for maps that gets rid of the gray background.  Finally, we'll give the legend the title "Percent Rural" (and multiply the values of the variable by 100).
