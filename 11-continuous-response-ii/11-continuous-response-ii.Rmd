...
<!-- There are 2 moderndive datasets and the parallel slopes function from the `moderndive` package that are used extensively in this chapter. Does the `moderndive` removal affect just datasets, or functions as well? -->
...
<!-- EC: How in depth do we need to go in this section? Can we assume that students have already used the UT Austin data before? -->
...
```{r echo=FALSE, fig.cap="Relationship between credit card debt and credit limit/income.", fig.height=3.2}
...
```{r echo=FALSE, fig.cap="Relationship between credit card debt and income.", fig.height=1.8}
...
```{r echo=FALSE, fig.cap="Relationship between credit card debt and income by credit limit bracket.", fig.height=3}
