...
Last chapter, we learned about probability, the act of quantifying uncertainty. This chapter, we will be learning about *sampling*, the beginning of our journey toward inference. 
...
```{r sampling-exercise-1, echo=FALSE, fig.cap="An urn with red and white balls.", purl=FALSE, out.width = "95%"}
