...
```{r sampling-exercise-2, echo=FALSE, fig.cap="Inserting a shovel into the urn.", out.width = "100%"}
knitr::include_graphics("06-sampling/images/sampling_bowl_2.jpg")
```


```{r sampling-exercise-3, echo=FALSE, fig.cap="Removing 50 balls from the urn.", out.width = "100%"}
...
<!-- MF: Should this be hidden and created internally, or should it remain displayed as is the case for the urn object later in this chapter? -->
...
```{r accuracy-vs-precision, echo=FALSE, fig.cap="Comparing accuracy and precision.", out.width="75%", out.height="75%"}
...
<!-- MF: I feel like my explanations of parameter uncertainty & unmodeled variation are too similar. Is there another way to do this? -->
...
However, the **Rubin Table** can be applied to sampling. How? Let's find out.
