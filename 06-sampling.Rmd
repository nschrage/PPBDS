...
<!-- Maybe give some more discussion of precision versus accuracy. What are the tradeoffs? Let's say that you had a shovel which was bigger but which also, (because of magnetic properties?), tended to grab out more red. Should you use it? Depends in trade-offs! Discuss bias versus variance, maybe in a sidemargin. -->
...
<!-- Zoom with Cass and discuss Preceptor Tables and how to create them.  -->


# Sampling {#sampling}

<!-- Priorities: PAY attention Mak! --> 
...
<!-- MF: Is there a section on the Reduced Preceptor Table for further clarification? I'm having trouble explaining it in words/applying it to my bead example. -->
...
<!-- MF: Do I discuss mathematical formulas? Since we have already stated that this chapter does not have a math section? -->
