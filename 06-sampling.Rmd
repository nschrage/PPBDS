...
<!-- 1) Fix Eddard Stark quote. Perhaps: "One does not simply sample . . . without understanding the sampling distribution. -->

<!-- 2) Switch bead_ID to ID, throughout, including all table. The columns with names/numbers/whatever is always "ID". -->

<!-- 3) Add red line for root(n) to figure 17. Trick is stat_function: https://ggplot2.tidyverse.org/reference/stat_function.html -->
