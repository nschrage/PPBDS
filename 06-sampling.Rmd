...
<!-- 0) What fun videos should be added? Memes!!!!!! Fill it with memes! Cartoons. -->

<!-- 1) Start with a problem. How many people do I need to survey to have a 90% chance of getting within 2% of the truth? Power. End the chapter by answering the question.  -->
...
<!-- tibble(number_red = 0:2,  -->
<!--       prop_red = number_red/2400,  -->
<!--       draw = list(map_int(prop_red, ~rbinom(n = 3, size = 20, p = .)))) -->
