...
<!-- 1) Last section is called Virtues. Include the mathematical formula, as a reminder, in the Justice section. -->

<!-- Adding a discussion of the Four Virtues including their pictures. A paragraph or two about each. -->

<!-- ```{r echo=FALSE, fig.margin=TRUE} -->
<!-- knitr::include_graphics("other/images/fortitude.jpg") -->
<!-- ``` -->

<!-- 2) A bootstrap confidence interval should include the true mean 95% of the time. Also useful to make a cool plot showing this. -->

<!-- 3) Add the equations. -->

<!-- 4) Add the Preceptor table from chapter 3. -->
