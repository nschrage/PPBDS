...
<!-- Find a place to mention all the high quality sources listed below, perhaps in sidemargins. -->

<!-- This chapter is an excellent idea, but also fundamentally flawed in implementation. First, it is a great idea to have a dedicated resource, designed for our use, which we can point students to. We don't want to explain 100 times how to confirm that git is installed correctly. Second, the actual implementation here stinks. To fix: -->
...
<!-- 6) Make sure to cover obscure topics which matter to us. For example, the .gitignore file and, maybe, what the .Rproj file does. Make sure, at the beginning, to require the setting up of RStudio correctly. -->

<!-- Maybe have a test tutorial (Tutorial Zero) so students can see the whole process on Day 1? -->
...
These are the steps to take during the first class, of either Gov 50: Data or Gov 52: Models.
