...
<!-- AR: This takes forever to build.  Is there a way to fix that? -->
...
```{r reveal_by_day, cache = TRUE}
p + transition_reveal(Day)
```

- Show points:

```{r show_points, cache = TRUE}
p + 
  geom_point() +
...
```{r transition_states, cache = TRUE}
