...
```{r, include=FALSE}
# The vast majority of plots in this appendix take a while to make, so we cache
# them all. Maybe we should do this elsewhere? Or do it for the whole book? Or
# at least for the version we use on Github Actions?

knitr::opts_chunk$set(cache=TRUE)
library(tufte)
```

<!-- Out to add the hex for the package. -->
...
`r margin_note("Thanks to Alboukadel Kassambara for allowing us to use [his tutorial](https://www.datanovia.com/en/blog/gganimate-how-to-create-plots-with-beautiful-animation-in-r).")`
