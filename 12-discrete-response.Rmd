...
<!-- 1) Preamble: Intro paragraph to classification in general, both 0/1 and multiple categories. -->
...
<!-- * First a regression using just data from 2018 with rstanarm with conservative ~ age, gender, race, education. (Maybe leave out education because it is an ordered factor?) Within just this example, we can go through all of our themes.Rmd issues. -->

<!-- * Start with the usual EDA of the subset of cces data which we are using (only 2018 for now), which will be state, age, gender, race, education.  -->
