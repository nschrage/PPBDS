...
knitr::include_graphics(c("images/bank.jpg", "images/roll.jpg"))
```
...
knitr::include_graphics("images/1_paper_slips.png")
```
...
knitr::include_graphics("images/2_insert_in_hat.png")
```
...
knitr::include_graphics("images/3_draw_at_random.png")
```
...
knitr::include_graphics("images/4_put_it_back.png")
```
...
knitr::include_graphics("images/5_shared_spreadsheet.png")
```
...
train_samples <- bootstraps(train, times = 1000)
